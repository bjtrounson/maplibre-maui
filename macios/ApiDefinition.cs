...
// @protocol IMLNAnnotation <NSObject>
/*
...
// @interface MLNShape : NSObject <IMLNAnnotation, NSSecureCoding>
[BaseType (typeof(NSObject))]
...
// @protocol MLNOverlay <IMLNAnnotation>
/*
Check whether adding [Model] to this declaration is appropriate.
[Model] is used to generate a C# class that implements this protocol,
and might be useful for protocols that consumers are supposed to implement,
...
// @protocol IMLNFeature <IMLNAnnotation>
/*
Check whether adding [Model] to this declaration is appropriate.
[Model] is used to generate a C# class that implements this protocol,
and might be useful for protocols that consumers are supposed to implement,
...
protocol, then [Model] is redundant and will generate code that will never
be used.
*/[Protocol(Name="IMLNFeature")]
interface IMLNFeature : IMLNAnnotation
{
...
interface MLNAnnotationView : INSSecureCoding
{
	...
	// -(instancetype _Nonnull)initWithAnnotation:(id<IMLNAnnotation> _Nullable)annotation reuseIdentifier:(NSString * _Nullable)reuseIdentifier;
	[Export ("initWithAnnotation:reuseIdentifier:")]
	NativeHandle Constructor ([NullAllowed] IMLNAnnotation annotation, [NullAllowed] string reuseIdentifier);

	// -(void)prepareForReuse;
	[Export ("prepareForReuse")]
	void PrepareForReuse ();

	// @property (nonatomic) id<IMLNAnnotation> _Nullable annotation;
	[NullAllowed, Export ("annotation", ArgumentSemantic.Assign)]
	IMLNAnnotation Annotation { get; set; }
...
{
	// @required @property (nonatomic, strong) id<IMLNAnnotation> _Nonnull representedObject;
	[Abstract]
	[Export ("representedObject", ArgumentSemantic.Strong)]
	IMLNAnnotation RepresentedObject { get; set; }
...
interface MLNMapView : MLNStylable
{
	...
	// -(void)showAnnotations:(NSArray<id<IMLNAnnotation>> * _Nonnull)annotations animated:(BOOL)animated;
	[Export ("showAnnotations:animated:")]
	void ShowAnnotations (IMLNAnnotation[] annotations, bool animated);

	// -(void)showAnnotations:(NSArray<id<IMLNAnnotation>> * _Nonnull)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated __attribute__((deprecated("Use `-showAnnotations:edgePadding:animated:completionHandler:` instead.")));
	[Export ("showAnnotations:edgePadding:animated:")]
	void ShowAnnotations (IMLNAnnotation[] annotations, UIEdgeInsets insets, bool animated);

	// -(void)showAnnotations:(NSArray<id<IMLNAnnotation>> * _Nonnull)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated completionHandler:(void (^ _Nullable)(void))completion;
	[Export ("showAnnotations:edgePadding:animated:completionHandler:")]
	void ShowAnnotations (IMLNAnnotation[] annotations, UIEdgeInsets insets, bool animated, [NullAllowed] Action completion);
	...
	// @property (readonly, nonatomic) NSArray<id<IMLNAnnotation>> * _Nullable annotations;
	[NullAllowed, Export ("annotations")]
	IMLNAnnotation[] Annotations { get; }

	// -(void)addAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("addAnnotation:")]
	void AddAnnotation (IMLNAnnotation annotation);

	// -(void)addAnnotations:(NSArray<id<IMLNAnnotation>> * _Nonnull)annotations;
	[Export ("addAnnotations:")]
	void AddAnnotations (IMLNAnnotation[] annotations);

	// -(void)removeAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("removeAnnotation:")]
	void RemoveAnnotation (IMLNAnnotation annotation);

	// -(void)removeAnnotations:(NSArray<id<IMLNAnnotation>> * _Nonnull)annotations;
	[Export ("removeAnnotations:")]
	void RemoveAnnotations (IMLNAnnotation[] annotations);

	// -(MLNAnnotationView * _Nullable)viewForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("viewForAnnotation:")]
	[return: NullAllowed]
	MLNAnnotationView ViewForAnnotation (IMLNAnnotation annotation);
	...
	// @property (readonly, nonatomic) NSArray<id<IMLNAnnotation>> * _Nullable visibleAnnotations;
	[NullAllowed, Export ("visibleAnnotations")]
	IMLNAnnotation[] VisibleAnnotations { get; }

	// -(NSArray<id<IMLNAnnotation>> * _Nullable)visibleAnnotationsInRect:(CGRect)rect;
	[Export ("visibleAnnotationsInRect:")]
	[return: NullAllowed]
	IMLNAnnotation[] VisibleAnnotationsInRect (CGRect rect);

	// @property (copy, nonatomic) NSArray<id<IMLNAnnotation>> * _Nonnull selectedAnnotations;
	[Export ("selectedAnnotations", ArgumentSemantic.Copy)]
	IMLNAnnotation[] SelectedAnnotations { get; set; }

	// -(void)selectAnnotation:(id<IMLNAnnotation> _Nonnull)annotation animated:(BOOL)animated __attribute__((deprecated("Use `-selectAnnotation:animated:completionHandler:` instead.")));
	[Export ("selectAnnotation:animated:")]
	void SelectAnnotation (IMLNAnnotation annotation, bool animated);

	// -(void)selectAnnotation:(id<IMLNAnnotation> _Nonnull)annotation animated:(BOOL)animated completionHandler:(void (^ _Nullable)(void))completion;
	[Export ("selectAnnotation:animated:completionHandler:")]
	void SelectAnnotation (IMLNAnnotation annotation, bool animated, [NullAllowed] Action completion);

	// -(void)selectAnnotation:(id<IMLNAnnotation> _Nonnull)annotation moveIntoView:(BOOL)moveIntoView animateSelection:(BOOL)animateSelection completionHandler:(void (^ _Nullable)(void))completion;
	[Export ("selectAnnotation:moveIntoView:animateSelection:completionHandler:")]
	void SelectAnnotation (IMLNAnnotation annotation, bool moveIntoView, bool animateSelection, [NullAllowed] Action completion);

	// -(void)deselectAnnotation:(id<IMLNAnnotation> _Nullable)annotation animated:(BOOL)animated;
	[Export ("deselectAnnotation:animated:")]
	void DeselectAnnotation ([NullAllowed] IMLNAnnotation annotation, bool animated);
...
// @interface MLNUserLocation : NSObject <IMLNAnnotation, NSSecureCoding>
[BaseType (typeof(NSObject))]
...
interface MLNMapViewDelegate
{
	...
	// @optional -(MLNAnnotationImage * _Nullable)mapView:(MLNMapView * _Nonnull)mapView imageForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:imageForAnnotation:")]
	[return: NullAllowed]
	MLNAnnotationImage ImageForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);
	...
	// @optional -(MLNAnnotationView * _Nullable)mapView:(MLNMapView * _Nonnull)mapView viewForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:viewForAnnotation:")]
	[return: NullAllowed]
	MLNAnnotationView ViewForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);
	...
	// @optional -(void)mapView:(MLNMapView * _Nonnull)mapView didSelectAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:didSelectAnnotation:")]
	void DidSelectAnnotation (MLNMapView mapView, IMLNAnnotation annotation);

	// @optional -(void)mapView:(MLNMapView * _Nonnull)mapView didDeselectAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:didDeselectAnnotation:")]
	void DidDeselectAnnotation (MLNMapView mapView, IMLNAnnotation annotation);
	...
	// @optional -(BOOL)mapView:(MLNMapView * _Nonnull)mapView annotationCanShowCallout:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:annotationCanShowCallout:")]
	bool AnnotationCanShowCallout (MLNMapView mapView, IMLNAnnotation annotation);

	// @optional -(id<MLNCalloutView> _Nullable)mapView:(MLNMapView * _Nonnull)mapView calloutViewForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:calloutViewForAnnotation:")]
	[return: NullAllowed]
	MLNCalloutView CalloutViewForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);

	// @optional -(UIView * _Nullable)mapView:(MLNMapView * _Nonnull)mapView leftCalloutAccessoryViewForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:leftCalloutAccessoryViewForAnnotation:")]
	[return: NullAllowed]
	UIView LeftCalloutAccessoryViewForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);

	// @optional -(UIView * _Nullable)mapView:(MLNMapView * _Nonnull)mapView rightCalloutAccessoryViewForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:rightCalloutAccessoryViewForAnnotation:")]
	[return: NullAllowed]
	UIView RightCalloutAccessoryViewForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);

	// @optional -(void)mapView:(MLNMapView * _Nonnull)mapView annotation:(id<IMLNAnnotation> _Nonnull)annotation calloutAccessoryControlTapped:(UIControl * _Nonnull)control;
	[Export ("mapView:annotation:calloutAccessoryControlTapped:")]
	void CalloutAccessoryControlTapped (MLNMapView mapView, IMLNAnnotation annotation, UIControl control);

	// @optional -(void)mapView:(MLNMapView * _Nonnull)mapView tapOnCalloutForAnnotation:(id<IMLNAnnotation> _Nonnull)annotation;
	[Export ("mapView:tapOnCalloutForAnnotation:")]
	void TapOnCalloutForAnnotation (MLNMapView mapView, IMLNAnnotation annotation);
}
